...
class InstitutionTranslation(TranslatedFieldsModel):
    ...
    # more_about = RichTextField(blank=True, null=True, config_name='small', help_text='Text to appear after the "learn more about this institution" links')
